(define (problem door-1)
	...
	(:init
		(hasbattery robot01 battery04)
		(at key04c room09)
		(at key01c corridor00)
		(unlocked door01c)
		;; robot location
		(at 830 (at robot01 corridor01))
		(at 1245 (unlocked door02c))

		(at 730 (not (at key02c corridor01)))
		(at 1245 (at key02c corridor01))
