(define (problem door-1)
	...
	(:init
		...
		(at 730 (at key01c room09))

		;; robot location
		(at 730 (hasbattery robot01 battery03))
		(at 730 (at robot01 corridor03))
		(at 1245 (unlocked door03c))
...
(at key00c room09)
		...
		;;(at 730 (not (at key03c corridor03))
		(at 1245 (at key03c corridor03))
