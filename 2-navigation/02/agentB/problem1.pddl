(define (problem door-1)
	...
	battery03 battery04 battery05 - battery
	)
	(:init
		(at 15 (not (at key01c room11)))
		(at 680 (at key01c corridor00))
		(at 680 (unlocked door01c))


		(at 1345 (not (at key02c corridor01)))
		(at 1345 (at key02c corridor01))
		(at 1345 (unlocked door02c))


		;; robot location
		(at robot01 corridor00)
...
(at key00c room09)
		...
		(at battery03 corridor00)
		(at battery04 room09)
		(at battery05 corridor00)
