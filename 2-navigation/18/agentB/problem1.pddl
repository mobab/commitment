(define (problem door-1)
	...
	(:init
		(at 15 (not (at key00c room10)))
		(at 580 (at key00c corridor00))
		(at 580 (unlocked door05c))

		(at 730 (not (at key01r corridor02)))
		(at 1245 (at key01r corridor02))
		(at 1245 (unlocked door01r))
		;; robot location
		(at robot01 room10)
