(define (problem log-1)
	...
	city0 - city
	city1 - city
	village0 village3 village4 village5 - village
	;;village3,village4 village5 villages in city0 
	)
	;; REPLANNING PROBLEM
	(:init

		(at 1800 (at driver1 city1))
		(at 1800 (at driver2 city1))

		(at 1800 (at vehicle2 city1))


		;(at 5 (at van0 city0))
		(at 1800 (at vehicle3 city1))
		;(at 5 (at truck0 city0))
		(at 1800 (at vehicle0 village0))
		...
		(= (duration-driving village3 village0) 360)
		...
		(= (duration-driving village4 village0) 360)
		...
		(= (duration-driving village5 village0) 380)
		...
		(= (duration-driving village0 village3) 360)
		(= (duration-driving village0 village4) 360)
		(= (duration-driving village0 village5) 380)
		...
		(= (duration-walking city1 village0) 240000)
		...
		(= (duration-walking village3 village0) 240000)
		...
		(= (duration-walking village4 village0) 240000)
		...
		(= (duration-walking village5 village0) 240000)
		...
		(= (duration-walking village0 city1) 240000)
		(= (duration-walking village0 city0) 120)
		(= (duration-walking village0 village3) 240000)
		(= (duration-walking village0 village4) 240000)
		(= (duration-walking village0 village5) 240000)
